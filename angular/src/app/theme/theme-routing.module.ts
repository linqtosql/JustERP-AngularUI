...
const routes: Routes = [
    {
        ...
        "children": [
            ...
            {
                "path": "components\/forms\/widgets\/bootstrap-selectsplitter",
                "loadChildren": ".\/pages\/default\/components\/forms\/widgets\/widgets-bootstrap-selectsplitter\/widgets-bootstrap-selectsplitter.module#WidgetsBootstrapSelectsplitterModule"
            },
            {
