  ...
  $.fn.mDatatable = function(options) {
    ...
    var dt = {
      ...
      getData: function() {
        ...
        var paramsDataMap = API.getOption("data.source.read.paramsDataMap");
        if (typeof (paramsDataMap) === "function") params.data = paramsDataMap(params.data);

        return $.ajax(params)
        .then(function (data) {
          var mapCallback = API.getOption("data.source.read.mapCallback");
